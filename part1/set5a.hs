...
data Vehicle = Bike | Tram | Train | Bus
...
data Person = CreatePerson String Int
  deriving Show

-- fred is a person whose name is Fred and age is 90
fred :: Person
fred = CreatePerson "Fred" 90

-- getName returns the name of the person
getName :: Person -> String
getName (CreatePerson name _) = name 

-- getAge returns the age of the person
getAge :: Person -> Int
getAge (CreatePerson _ age) = age

-- setName takes a person and returns a new person with the name changed
setName :: String -> Person -> Person
setName name (CreatePerson _ age) = CreatePerson name age 

-- setAge does likewise for age
setAge :: Int -> Person -> Person
setAge age (CreatePerson name _ ) = CreatePerson name age 
...
-- toNat n = Just (PlusOne (toNat (n - 1)))
